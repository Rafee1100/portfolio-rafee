                      ...
                      <CButton
                        ...
                        onClick={(e) => {
                          handleSubmit(e, (d) => {
                            emailjs
                            .send(
                              "service_at41erg", // Replace with your EmailJS Service ID
                              "template_ybgw1w9", // Replace with your EmailJS Template ID
                              d,
                              "d4D2qLRy5cYyzhZTd" // Replace with your EmailJS Public Key
                            )
                            .then((response) => {
                              console.log("SUCCESS!", response.status, response.text);
                              setsubmitted({
                                success: true,
                                message: "Thank you. I'll be in contact with you shortly.",
                              });
                            })
                            .catch((error) => {
              ...
              <Col className="ml-auto" md="4">
                <div className="info info-horizontal">
                  ...
                  <div className="description">
                    ...
                    <a href="https://www.linkedin.com/in/abdullahalrafee/" className="text-info" target="_blank" rel="noopener noreferrer">
                      Abdullah Al Rafee
                    </a>
                  </div>
                </div>
                <div className="info info-horizontal">
                  ...
                  <div className="description">
                    ...
                    <p>
                      29/2, Rd-01, Shornolota Tower, Matuail <br />
                      Dhaka 1206 <br />
                      Bangladesh
                    </p>
                  </div>
                ...
                <div className="info info-horizontal">
                  ...
                  <div className="description">
                    ...
                    <p>
                      Abdullah Al Rafee <br />
                      +880 1779404301 <br />
                      Mon - Fri, 10:00-22:00 BST
                    </p>
                  </div>
                </div>
              </Col>
